...
namespace Oracle.Models
{
    ...
    public partial class measurement
    {
        public measurement()
        {
            ...
            this.productsVolume = new HashSet<product>();
            this.productsWeight = new HashSet<product>();
        }
        ...
        public virtual ICollection<product> productsVolume { get; set; }
        public virtual ICollection<product> productsWeight { get; set; }
    }
}
