...
namespace Oracle.Models
{
    ...
    public partial class recipeEntities1 : DbContext
    {
        ...
        public DbSet<products_in_company> products_in_company { get; set; }
        ...
        public DbSet<products_per_measuremnts> products_per_measuremnts { get; set; }
        public DbSet<recipe> recipes { get; set; }
        public DbSet<recipe_for_user> recipe_for_user { get; set; }
        public DbSet<special_equipment> special_equipment { get; set; }
        ...
        public virtual int StoredProcedure1(Nullable<int> measurements_id, Nullable<int> product_id, Nullable<double> amount)
        {
            var measurements_idParameter = measurements_id.HasValue ?
                new ObjectParameter("measurements_id", measurements_id) :
                new ObjectParameter("measurements_id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("StoredProcedure1", measurements_idParameter, product_idParameter, amountParameter);
        }
